...
const SECTIONS = [
  ...
  // Client walkthrough 02:30–02:36 — the org needs to extend both lists itself.
  { href: "/settings/visit-types", title: "Visit types", desc: "What appears in the visit-type dropdown when scheduling." },
