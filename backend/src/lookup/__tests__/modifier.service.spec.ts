...
const modifiers: ModifierRecord[] = [
  {
    modifier: '25',
    description: 'E/M same day',
    modifier_type: 'distinct_service',
    payer_applicability: [],
    effective_date: T('1992-01-01'),
    expiration_date: null,
  },
  {
    modifier: '59',
    description: 'Distinct service fallback',
    modifier_type: 'distinct_service',
    payer_applicability: [],
    effective_date: T('1996-01-01'),
    expiration_date: null,
  },
  {
    modifier: 'XE',
    ...
    modifier_type: 'distinct_service',
    payer_applicability: [],
    effective_date: T('2015-01-01'),
    expiration_date: null,
  },
  {
    modifier: 'XU',
    description: 'Unusual non-overlapping',
    modifier_type: 'distinct_service',
    payer_applicability: [],
    effective_date: T('2015-01-01'),
    expiration_date: null,
  ...
  {
    modifier: '95',
    description: 'Sync A/V telemed',
    modifier_type: 'telehealth',
    payer_applicability: [],
    effective_date: T('2017-01-01'),
    expiration_date: null,
  },
  {
    modifier: 'GT',
    description: 'Legacy A/V',
    modifier_type: 'telehealth',
    payer_applicability: ['Medicare'],
    effective_date: T('1999-01-01'),
    expiration_date: null,
  },
  {
    modifier: 'JW',
  ...
  {
    modifier: 'JZ',
    description: 'No wastage',
    modifier_type: 'drug',
    payer_applicability: ['Medicare'],
    effective_date: T('2023-07-01'),
    expiration_date: null,
  },
  {
    modifier: 'GA',
    description: 'Signed ABN',
    modifier_type: 'abn',
    payer_applicability: ['Medicare'],
    effective_date: T('2002-01-01'),
    expiration_date: null,
  },
  {
    modifier: 'GZ',
    description: 'Expected denial no ABN',
    modifier_type: 'abn',
    payer_applicability: ['Medicare'],
    effective_date: T('2002-01-01'),
    expiration_date: null,
...
const relationships: ModifierRelationshipRecord[] = [
  {
    ...
    rationale: 'CMS prefers specific X-modifier',
    source_url: 'https://example/ncci',
  },
  {
    modifier_a: 'XU',
    modifier_b: '59',
  ...
  },
  {
    ...
    rationale: 'Never combine 59 with X-modifier',
    source_url: null,
  },
  {
    modifier_a: '59',
  ...
  },
  {
    ...
    modifier_b: 'JZ',
    relationship_type: 'mutually_exclusive',
    rationale: 'Wastage vs no-wastage',
    source_url: null,
  },
  {
    modifier_a: 'GA',
...
describe('validateModifierSet', () => {
  ...
  it('flags JW + JZ as mutually exclusive', () => {
    ...
    expect(
      issues.some(
        (i) =>
          i.kind === 'mutually_exclusive' &&
          i.modifiers.includes('JW') &&
          i.modifiers.includes('JZ'),
      ),
    ).toBe(true);
  });
  ...
  it('flags JZ before its 2023-07-01 effective date', () => {
    ...
    expect(issues).toEqual([expect.objectContaining({ kind: 'expired_modifier' })]);
  });
